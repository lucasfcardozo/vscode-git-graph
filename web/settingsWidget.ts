	...
	private render() {
		if (this.currentRepo !== null && this.repo !== null) {
			...
			let html = '<div class="settingsSection general"><h3>General</h3>' +
				...
				'<br/><label id="settingsShowAvatarsInGraph"><input type="checkbox" id="settingsShowAvatarsInGraphCheckbox" tabindex="-1"><span class="customCheckbox"></span>Show commit avatars in the graph</label><span class="settingsWidgetInfo" title="Display the committer\'s avatar in the graph (in place of the commit dot) instead of next to the author name. Requires &quot;Fetch Avatars&quot; to be enabled.">' + SVG_ICONS.info + '</span>' +
				'</div>';
